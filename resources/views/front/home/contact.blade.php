                        ...
                        <form class="widget-contact-form" action="{{ route('contact.store') }}" role="form" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" aria-required="true" name="name" class="form-control required name" placeholder="Enter your Name" required autofocus>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="email">Email</label>
                                    <input type="email" aria-required="true" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}"  placeholder="Enter your Email" required autofocus>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <address>
                                ...
                                Phone:</h4> +977 1 4488991, 4489868
                                    <br>  Email: info@naat147.com
                            </address>
                        </div>
                    </div>
